...
- **Aucune écriture directe sur `main`** : toute modification passe par une branche courte (`feat/…`, `fix/…`) et une Pull Request.
- Une PR n'est fusionnable que si la **CI est verte** (lint, tests, `security.yml` — EP-02.05/02.06/02.07) et qu'elle a été revue.
